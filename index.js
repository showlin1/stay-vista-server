...
const corsOptions = {
  origin: ['http://localhost:5173', 
    'https://stay-vista-5111a.web.app',
    'http://localhost:5174',
    'https://stay-vista-5111a.firebaseapp.com'],
  credentials: true,
...
const sendEmail = (emailAddress, emailData) => {
  ...
  const mailBody = {
    from: `"WorldVista" <process.env.TRANSPORTER_EMAIL>`, // sender address
  ...
  try {
    ...
    app.post('/booking', verifyToken, async (req, res) => {
      ...
      sendEmail(bookingData?.guest?.email, {
        ...
        message: `You've successfully booked a room through WorldVista. 
...
app.get('/', (req, res) => {
  res.send('Hello from WorldVista Server..')
})

// test email
// app.get('/email', async (req, res) => {
//   const { data, error } = await resend.emails.send({
//     from: 'WorldVista <onboarding@resend.dev>',
//     to: ['showlinakter77@gmail.com'],
//     subject: 'Hello World',
...
app.listen(port, () => {
  console.log(`WorldVista is running on port ${port}`)
})
